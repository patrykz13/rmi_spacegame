...
public interface ServerInterface extends Remote
{
    ...
    void broadcastRoundAnswer(String answer,String commanderName) throws RemoteException;
    ...
    void startRound(Integer seconds,String commanderName) throws RemoteException;
